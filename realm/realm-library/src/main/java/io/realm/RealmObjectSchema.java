...
public abstract class RealmObjectSchema {
    ...
    static {
        ...
        dictionaryMap.put(byte[].class, new FieldMetaData(RealmFieldType.BINARY, RealmFieldType.STRING_TO_BINARY_MAP, false));
    ...
    static final class FieldMetaData {
        ...
        final RealmFieldType collectionType; // Underlying Realm type for RealmLists containing this type
